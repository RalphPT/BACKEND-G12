...
SECRET_KEY = 'django-insecure-7gt%2dwju-fnk+av&a&(f=xidmouk-x7&f%n)vuddlmnt4z5xo'
...
INSTALLED_APPS = [
    ...
    'gestion', #Agregaro para hacer migraciones
    'rest_framework',
    'drf_yasg',
]
...
#MEDIA ROOT JAMAS DEBE ESTAR VACIO, CASO CONTRARIO TENDRÁN ACCESO TOTAL AL PROYECTO
...
# es el endpoint en cual se podra acceder al archivo
MEDIA_URL = 'imagenes/'