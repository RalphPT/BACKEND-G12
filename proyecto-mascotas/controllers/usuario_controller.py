...
class UsuarioController(Resource):
    ...
    def post(self):
        ...
        nuevoUsuario = UsuarioModel(**dataValidada
            # nombre = 'Rafael', apellido='Percca', correo = 'ralphpt@gmail.com', dni='12345678'
            )
        ...
        try:
            # se usa para transacccion sirve para indicar que todos los cambios se guarden de manera permanente, sino hacemos el commit entonces no se guardara la informacion de manera permanente
            conexion.session.commit()
            return{
                'message': 'Usuario creado exitosamente'
            }, 201 # Created (Creado exitosamente)
        except Exception as error:
            # rollback > para retroceder y dejar todos los posibles cambios sin efecto (los incrementadores, nuevos registrosm actualizaciones y eliminaciones) queda sin efecto
