 ...
 <body data-new-gr-c-s-loaded="14.1030.0" style="width:100%;font-family:arial, 'helvetica neue', helvetica, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
  <div class="es-wrapper-color" style="background-color:#F6F6F6"><!--[if gte mso 9]>
   ...
   <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#F6F6F6">
    ...
    texto = MIMEText(body, 'plain') #plain, indica si será un texto plano o html, para este caso texto plano
    ...
    conexion.sendmail(from_addr='perccatrejorafael@gmail.com', to_addrs=destinatarios, msg=mensaje.as_string())
...
enviarCorreo('raffotrejo@gmail.com')