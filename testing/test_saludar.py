...
def test_saludar(monkeypatch):
    ...
    print(monkeypatch)
    # setattr > primer parametro de le diremos que queremos modificar (archivo o un modulo), segundo parametro indicaremos que funcion o metodo queremos modificar, tercer parametro el nuevo comportamiento de el segundo parametro indicado
