...
export function validarData({error, message, data}){
    ...
    if(error){
        // La clase Error admite un mensaje que tiene que string, no puede JSON u otro tipo de dato por lo que convertimos nuestro json a un stringify utilizando el metodo stringify
